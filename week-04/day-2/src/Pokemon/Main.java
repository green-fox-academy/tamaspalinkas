...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("I choose you, " + pokemonToUse(pokemonOfAsh, wildPokemon));
    }
    public static String pokemonToUse(List<Pokemon> pokemonOfAsh, Pokemon wildPokemon) {
        for (int i = 0; i < pokemonOfAsh.size(); i++) {
            if (pokemonOfAsh.get(i).isEffectiveAgainst(wildPokemon)){
                return pokemonOfAsh.get(i).name;
            }
        }
        return "No pokemon";
    }
